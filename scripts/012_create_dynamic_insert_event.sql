...
BEGIN
  ...
  EXECUTE format(
    'INSERT INTO events (id, title, description, date, %I, location, guest_limit, %I, host_name, host_email, host_user_id, %I, created_at) VALUES ($1, $2, $3, $4::timestamptz, $5, $6, $7, $8, $9, $10, $11, $12, NOW())',
    'time', 'deadline', 'active'
  ) USING v_id, p_title, p_description, p_date, p_time, p_location, p_guest_limit, p_deadline, p_host_name, p_host_email, p_host_user_id, true;
